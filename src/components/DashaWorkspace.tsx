...
type Tab = 'timeline' | 'finder' | 'events' | 'history' | 'patterns' | 'overlap' | 'systems';
const TABS: { key: Tab; label: string }[] = [{ key: 'timeline', label: 'Timeline' }, { key: 'finder', label: 'Finder' }, { key: 'events', label: 'Events' }, { key: 'history', label: 'History' }, { key: 'patterns', label: 'Patterns' }, { key: 'overlap', label: 'Overlap' }, { key: 'systems', label: 'Systems' }];
